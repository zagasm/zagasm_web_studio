...
import {
  require_browser
} from "./chunk-RUBZTCP6.js";
import {
  useBootstrapPrefix
} from "./chunk-RN6KZ2JX.js";
import {
  require_jsx_runtime
...
var divWithClassName_default = (className) => (
  ...
  React2.forwardRef((p, ref) => (0, import_jsx_runtime.jsx)("div", {
    ...p,
    ref,
...
var AlertLink = React6.forwardRef(({
  className,
  bsPrefix,
...
function getReactVersion() {
  const parts = React9.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
function useMergedRefs(refA, refB) {
  return (0, import_react20.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var Alert = React13.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime9.jsx)(Transition2, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
