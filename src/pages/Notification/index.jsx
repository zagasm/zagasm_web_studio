    ...
    const fetchNotifications = async () => {
        ...
        try {
            ...
            if (response.data.success && response.data.notifications.length > 0) {
                ...
                // playSound();
                if (response.data.notifications.length < 3) setHasMore(false);
            } else {
                setHasMore(false);
            }
        } catch (err) {
        ...
        <div className="notifications-page">
            ...
            <div className="container-fluid p-0">
                <div className="offset-xl-3 offset-lg-1 offset-md-1">
                    <main className="col col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12 main-container" style={{ paddingTop: '80px' }}>
